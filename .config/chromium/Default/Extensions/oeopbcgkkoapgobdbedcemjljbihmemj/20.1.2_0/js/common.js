...
function initConsole() {
	if (bg.Settings.read("console_messages")) {
		...
		*/
		...
		// commented because getBackgroundPage I think caused dead object issue in FF
...
if (window.chrome && chrome.extension && chrome.extension.getBackgroundPage() && chrome.extension.getBackgroundPage().wrappedDB && chrome.extension.getBackgroundPage().wrappedDB.opened) {
	initCommon();
}
