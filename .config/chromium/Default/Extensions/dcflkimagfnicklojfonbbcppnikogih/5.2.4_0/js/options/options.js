...
/*			var currentValue = null;			
			var radioElems = document.getElementsByName( "fvd.video_more" );
		...
		refreshOptionValues: function( callback ){
			...
			for (var i = 0; i != options.length; i++) 
			{
				...
				this._setOptionVal( option, YouTubeSmartPause.Prefs.get( option.getAttribute( "sname" ) ) );				
			}
		},
		...
		applyChanges: function( applyChangesCallback ){
			...
			for( var i = 0; i != options.length; i++ )
			{
				...
				YouTubeSmartPause.Prefs.set( name, this._getOptionValue( options[i] ) );
...
//			document.location = 'newtab.html';
		...
		openGetSatisfactionSuggestions: function(){
			window.open( "https://fvdmedia.userecho.com/list/21579-chrome-extensions/?category=4922" );
		},
		// -----------------------------------------------	
