(function($) {
    ...
    $.fn.contextmenu = function(option) {
        option = $.extend({ alias: "cmroot", width: 120, eventName : 'contextmenu'}, option);
        ...
        var buildGroup = function(obj) {
            ...
            $(this).css({"min-width" : obj.width}).click(returnfalse).mousedown(returnfalse).appendTo($("body"));
            obj = null;
            return this;
        };
        ...
        var addItems = function(gidx, items) {
            ...
            for (var i = 0; i < items.length; i++) {
                if (items[i].type == "splitLine") {
                    ...
                    $(tmp).bind(option.eventName, returnfalse).hover(overItem, outItem);
                } 
        ...
        var hideMenuOnKeyPress = function(e) {
            if(e.keyCode == 13 || e.keyCode == 27 || e.keyCode == 9 || e.keyCode == 8 || e.keyCode == 32) { // enter or esc or tab or back or space
                hideMenuPane();
            }
        };
        ...
        function showMenu(e, menutarget) {
            ...
            $(document).one('keyup', hideMenuOnKeyPress);
        }
        ...
        var me = $(this).each(function() {
            return $(this).bind(option.eventName, function(e) {
