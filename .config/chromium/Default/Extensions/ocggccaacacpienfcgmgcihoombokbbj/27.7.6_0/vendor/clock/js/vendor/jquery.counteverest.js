...
(function ($, window, document, undefined) {
	...
	var p = 'countEverest',
		def = {
			...
			/**
			 * Display timer am/pm format
			 */
			displayAmPmFormat: null,
	...
	Plugin.prototype = {
		init: function() {
			...
			if (s.displayAmPmFormat != null) {
				s.displayAmPmFormat = s.displayAmPmFormat ? true : false;
			}
		...
		output: function() {
			...
			t.writeDigitsToDom(s.hoursWrapper, s.displayAmPmFormat ? (t.hours == "00" ? "12" : parseInt(t.hours)) : parseInt(t.hours), 'ce-hours-digit');
