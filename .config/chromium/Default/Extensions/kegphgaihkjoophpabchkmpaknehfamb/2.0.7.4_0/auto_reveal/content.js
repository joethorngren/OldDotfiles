...
var auto_reveal = new (function(window, undefined) {
      ...
      if (catc2.settings.highlight == "Yes" || catc2.settings.highlight == "true") {
        $(function () {
          ...
          BS.sendMessage({call: 'cf'}, function (response) {
            ...
            if (isCart || utils.isCart(helper.cartKeyword)) {
              if (cf.blacklist[domain] == undefined) {
  ...
  me.checkForUpdatesIfNeeded = function () {
    BS.sendMessage({call: 'checkForUpdatesIfNeeded'});
  };
